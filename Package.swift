...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/a27f649619b256db/googlemobileadsios-spm-10.1.0.zip",
      checksum: "a27f649619b256db4b15fff91660efade66e24a0ad2b7b328a97081b9334acf6"
    ),
  ]
)
